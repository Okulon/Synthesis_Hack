...
export const daovaultAbi = parseAbi([
  ...
  "function redeemProRata(uint256 shares, address[] assetsHint)",
  "function redeemToSingleAsset(uint256 shares, address assetOut, uint256 minAmountOut, (address,address,bytes)[] steps)",
